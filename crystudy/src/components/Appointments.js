export const appointments = [
  {
    title: 'Spring 서버 공부',
    startDate: new Date(2021, 5, 7, 9, 30),
    endDate: new Date(2021, 5, 7, 11, 30),
  }, {
    title: '알고리즘 스터디1',
    startDate: new Date(2021, 5, 8, 12, 0),
    endDate: new Date(2021, 5, 8, 14, 0),
  }, {
    title: '알고리즘 스터디2',
    startDate: new Date(2021, 5, 10, 14, 30),
    endDate: new Date(2021, 5, 10, 15, 30),
  }, {
    title: '알고리즘 스터디3',
    startDate: new Date(2021, 5, 12, 14, 30),
    endDate: new Date(2021, 5, 12, 15, 30),
  }, {
    title: '웹/앱 프로젝트 개발',
